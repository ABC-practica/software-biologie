...
public class OpenGLRenderer implements
    ...
    private final Map<Texture, Integer> textureIds =
            new HashMap<>();
    ...
    public void refresh() {
        ...
        /*
         * Rendering is continuous (a tight busy-loop, not
         * glfwWaitEvents), so the renderer is already refreshing
         * every frame - there is nothing to "wake up".
         *
         * Intentionally a no-op: it must NOT call GLFW functions from
         * this thread. See close() for why.
         */
    }
